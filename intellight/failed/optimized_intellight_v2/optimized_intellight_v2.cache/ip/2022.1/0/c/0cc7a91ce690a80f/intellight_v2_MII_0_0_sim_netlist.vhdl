...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MII is
  ...
  attribute SOFT_HLUTNM of en0_i_2 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of en1_i_1 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of en2_i_1 : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of en3_i_1 : label is "soft_lutpair34";
begin
...
en0_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
en0_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
