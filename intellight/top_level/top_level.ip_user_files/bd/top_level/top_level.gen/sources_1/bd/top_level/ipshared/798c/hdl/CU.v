...
//    output wire RD,
//        // for debugging 
    output wire [CTR_WIDTH-1:0] debug_step,
    output wire [CTR_WIDTH-1:0] debug_episode,
    output wire [CTR_WIDTH-1:0] debug_epsilon,
    output wire [4:0] debug_cs,
    output wire [4:0] debug_ns,
    output wire finish, learning,
    output reg wen,
    output wire idle 
    );
...
//    end
    ...
    assign finish   = (cs==S_DONE);
    assign learning = (cs==S_L5);
...
//    // For debugging
    assign debug_cs = cs;
    assign debug_ns = ns;
    assign debug_episode = episode;
    assign debug_step = step;  
    assign debug_epsilon = epsilon;  
endmodule
