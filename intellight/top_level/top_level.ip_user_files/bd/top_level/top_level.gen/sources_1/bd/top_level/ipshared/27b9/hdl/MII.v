...
//    output wire [L_WIDTH/2-1:0] A_dur
    ...
    // Address Configuration
    assign wr_addr  = (S_reg[4]<<3) | {ADDR_WIDTH{1'b0}};
    assign rd_addr  = (S<<3) | {ADDR_WIDTH{1'b0}};
    ...
    generate 
        for (i = 0; i < N_LEVEL; i = i + 1) begin 
            ...
            assign wen_bram[EN_WIDTH*(i+1)-1:EN_WIDTH*i] = ((A_dur==i)&(wen))? {EN_WIDTH{1'b1}}:{EN_WIDTH{1'b0}}; 
        end
    endgenerate 
