...
module Accelerator
   ...
   (  
      ...
      input     wire [(L_WIDTH)*(2**(L_WIDTH/2))-1:0] L_dec, L_inc_a, L_inc_b, L_inc_c, L_inc_d,
      ...
      output    wire                                 finish, idle, learning);
  ...
  wire [(L_WIDTH)*(2**(L_WIDTH/2))-1:0] INPUT_0_L_dec;
  wire [(L_WIDTH)*(2**(L_WIDTH/2))-1:0] INPUT_0_L_inc_a;
  wire [(L_WIDTH)*(2**(L_WIDTH/2))-1:0] INPUT_0_L_inc_b;
  wire [(L_WIDTH)*(2**(L_WIDTH/2))-1:0] INPUT_0_L_inc_c;
  wire [(L_WIDTH)*(2**(L_WIDTH/2))-1:0] INPUT_0_L_inc_d;
