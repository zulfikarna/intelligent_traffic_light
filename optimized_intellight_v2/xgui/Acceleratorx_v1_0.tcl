...
proc update_PARAM_VALUE.N_LEVEL { PARAM_VALUE.N_LEVEL } {
	# Procedure called to update N_LEVEL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.N_LEVEL { PARAM_VALUE.N_LEVEL } {
	# Procedure called to validate N_LEVEL
	return true
}
