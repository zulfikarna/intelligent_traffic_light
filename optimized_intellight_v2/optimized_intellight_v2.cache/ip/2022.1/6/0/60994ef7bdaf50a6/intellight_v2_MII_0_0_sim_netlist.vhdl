...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MII is
  ...
  signal \A_reg_reg[1]\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \A_reg_reg[2]\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \A_reg_reg_n_0_[1][2]\ : STD_LOGIC;
  signal \A_reg_reg_n_0_[1][3]\ : STD_LOGIC;
...
decod0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_wen_decoder
     port map (
      ...
      D(1) => wen_bram_temp(3),
      D(0) => wen_bram_temp(1),
      Q(1 downto 0) => \A_reg_reg[1]\(1 downto 0)
    );
decod2: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_data_config
     port map (
      ...
      Q(1 downto 0) => \A_reg_reg[2]\(1 downto 0),
