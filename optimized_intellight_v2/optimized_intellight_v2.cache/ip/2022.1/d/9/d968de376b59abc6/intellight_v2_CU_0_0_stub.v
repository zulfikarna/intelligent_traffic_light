...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, run, mode, max_step, max_episode, seed, 
  ...
  idle)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,run,mode,max_step[15:0],max_episode[15:0],seed[15:0],A_sel,A_rand[3:0],S0[11:0],PG,QA,SD,RD,wire_step[15:0],wire_episode[15:0],wire_epsilon[15:0],wire_cs[4:0],wire_ns[4:0],finish,wen,idle" */;
  input clk;
  input rst;
  input run;
  input mode;
