...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, rst, alpha, gamma, Droad0, Droad1, Droad2, Droad3, 
  R, A, A_road, Q_new)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,alpha[2:0],gamma[2:0],Droad0[63:0],Droad1[63:0],Droad2[63:0],Droad3[63:0],R[15:0],A[5:0],A_road[2:0],Q_new[15:0]" */;
  input clk;
  input rst;
  input [2:0]alpha;
  input [2:0]gamma;
