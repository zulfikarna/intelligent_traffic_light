...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_CU is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_cs[16]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \FSM_onehot_cs[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \FSM_onehot_cs[9]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of PG_INST_0_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of SD_INST_0_i_1 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of finish_i_3 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of wen_INST_0 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \wire_cs[4]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wire_ns[0]_INST_0_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \wire_ns[1]_INST_0_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \wire_ns[3]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \wire_ns[3]_INST_0_i_1\ : label is "soft_lutpair6";
...
SD_INST_0_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
finish_i_5: unisim.vcomponents.LUT6
    generic map(
...
\wire_cs[1]_INST_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\wire_ns[0]_INST_0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\wire_ns[4]_INST_0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BAAA"
    )
        port map (
