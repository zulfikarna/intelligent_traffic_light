...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SD is
  ...
  attribute SOFT_HLUTNM of \L1[2]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \level0[0]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \level0[1]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \level0[2]_INST_0\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \level1[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \level1[1]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \level1[2]_INST_0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \level2[0]_INST_0\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \level2[1]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \level2[2]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \level3[0]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \level3[1]_INST_0\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \level3[2]_INST_0\ : label is "soft_lutpair3";
begin
