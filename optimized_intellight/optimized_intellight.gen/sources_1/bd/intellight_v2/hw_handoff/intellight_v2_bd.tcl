...
0#Enet 0}\
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins intellight_0/S00_AXI]
  ...
  connect_bd_net -net MII_0_WRITE_ADDR [get_bd_pins Action_RAM/WRITE_ADDR] [get_bd_pins MII_0/WR_ADDR]
  ...
  connect_bd_net -net MII_0_wen0 [get_bd_pins Action_RAM/wen0] [get_bd_pins MII_0/wen0]
  connect_bd_net -net MII_0_wen1 [get_bd_pins Action_RAM/web1] [get_bd_pins MII_0/wen1]
  connect_bd_net -net MII_0_wen2 [get_bd_pins Action_RAM/web2] [get_bd_pins MII_0/wen2]
  connect_bd_net -net MII_0_wen3 [get_bd_pins Action_RAM/web3] [get_bd_pins MII_0/wen3]
  ...
  connect_bd_net -net QA_0_Qnew [get_bd_pins Action_RAM/Q] [get_bd_pins QA_0/Qnew]
  ...
  connect_bd_net -net clka_0_1 [get_bd_pins Action_RAM/clk] [get_bd_pins CU_0/clk] [get_bd_pins MII_0/clk] [get_bd_pins PG_0/clk] [get_bd_pins QA_0/clk] [get_bd_pins RD_0/clk] [get_bd_pins SD_0/clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins intellight_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_clk_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_100M_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins intellight_0/s00_axi_aresetn] [get_bd_pins rst_clk_100M/peripheral_aresetn]
  connect_bd_net -net rsta_0_1 [get_bd_pins Action_RAM/rst] [get_bd_pins CU_0/rst] [get_bd_pins MII_0/rst] [get_bd_pins PG_0/rst] [get_bd_pins QA_0/rst] [get_bd_pins RD_0/rst] [get_bd_pins SD_0/rst] [get_bd_pins rst_clk_100M/peripheral_reset]
