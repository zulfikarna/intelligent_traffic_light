...
################################################################
# This is a generated script based on design: intellight
#
...
proc create_hier_cell_PL_RAM { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXI_1] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI_2] [get_bd_intf_pins axi_bram_ctrl_2/S_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S_AXI_3] [get_bd_intf_pins axi_bram_ctrl_3/S_AXI]
  connect_bd_intf_net -intf_net S_AXI_0_1 [get_bd_intf_pins S_AXI_0] [get_bd_intf_pins axi_bram_ctrl_0/S_AXI]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins RAM0/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins RAM1/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_2_BRAM_PORTA [get_bd_intf_pins RAM2/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_2/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_3_BRAM_PORTA [get_bd_intf_pins RAM3/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_3/BRAM_PORTA]
  ...
  connect_bd_net -net s_axi_aresetn_0_1 [get_bd_pins rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_3/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: intellight_0, and set properties
  set intellight_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:intellight:1.0 intellight_0 ]
...
0#Enet 0}\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins PL_RAM/S_AXI_0] [get_bd_intf_pins axi_smc/M00_AXI]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins PL_RAM/S_AXI_1] [get_bd_intf_pins axi_smc/M01_AXI]
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins PL_RAM/S_AXI_2] [get_bd_intf_pins axi_smc/M02_AXI]
  connect_bd_intf_net -intf_net axi_smc_M03_AXI [get_bd_intf_pins PL_RAM/S_AXI_3] [get_bd_intf_pins axi_smc/M03_AXI]
  connect_bd_intf_net -intf_net axi_smc_M04_AXI [get_bd_intf_pins axi_smc/M04_AXI] [get_bd_intf_pins intellight_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net Action_RAM_D0 [get_bd_pins Action_RAM/D0] [get_bd_pins QA_0/Q0] [get_bd_pins intellight_0/Q0]
  connect_bd_net -net Action_RAM_D1 [get_bd_pins Action_RAM/D1] [get_bd_pins QA_0/Q1] [get_bd_pins intellight_0/Q1]
  connect_bd_net -net Action_RAM_D2 [get_bd_pins Action_RAM/D2] [get_bd_pins QA_0/Q2] [get_bd_pins intellight_0/Q2]
  connect_bd_net -net Action_RAM_D3 [get_bd_pins Action_RAM/D3] [get_bd_pins QA_0/Q3] [get_bd_pins intellight_0/Q3]
  ...
  connect_bd_net -net QA_0_Qnew [get_bd_pins Action_RAM/Q] [get_bd_pins PL_RAM/Q] [get_bd_pins QA_0/Qnew]
  connect_bd_net -net RD_0_R [get_bd_pins QA_0/R] [get_bd_pins RD_0/R]
  connect_bd_net -net SD_0_S [get_bd_pins MII_0/S] [get_bd_pins PG_0/S] [get_bd_pins SD_0/S]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net clka_0_1 [get_bd_pins Action_RAM/clk] [get_bd_pins CU_0/clk] [get_bd_pins MII_0/clk] [get_bd_pins PG_0/clk] [get_bd_pins PL_RAM/clk] [get_bd_pins QA_0/clk] [get_bd_pins RD_0/clk] [get_bd_pins SD_0/clk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins intellight_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_clk_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rsta_0_1 [get_bd_pins Action_RAM/rst] [get_bd_pins CU_0/rst] [get_bd_pins MII_0/rst] [get_bd_pins PG_0/rst] [get_bd_pins PL_RAM/rst] [get_bd_pins QA_0/rst] [get_bd_pins RD_0/rst] [get_bd_pins SD_0/rst] [get_bd_pins rst_clk_100M/peripheral_reset]
