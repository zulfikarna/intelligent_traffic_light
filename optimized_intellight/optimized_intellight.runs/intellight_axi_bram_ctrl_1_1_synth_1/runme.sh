...
HD_PWD='F:/intelligent_traffic_light/optimized_intellight/optimized_intellight.runs/intellight_axi_bram_ctrl_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intellight_axi_bram_ctrl_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intellight_axi_bram_ctrl_1_1.tcl
