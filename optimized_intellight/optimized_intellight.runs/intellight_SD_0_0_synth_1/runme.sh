...
HD_PWD='F:/intelligent_traffic_light/optimized_intellight/optimized_intellight.runs/intellight_SD_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intellight_SD_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intellight_SD_0_0.tcl
