...
HD_PWD='F:/riset/optimized_intellight/optimized_intellight.runs/intellight_RAM1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intellight_RAM1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intellight_RAM1_0.tcl
