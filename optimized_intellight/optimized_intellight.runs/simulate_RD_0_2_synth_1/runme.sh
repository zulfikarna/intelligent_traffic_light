...
HD_PWD='F:/intelligent_traffic_light/optimized_intellight/optimized_intellight.runs/simulate_RD_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simulate_RD_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simulate_RD_0_2.tcl
