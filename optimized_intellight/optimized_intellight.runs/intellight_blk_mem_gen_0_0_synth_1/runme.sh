...
HD_PWD='F:/riset/optimized_intellight/optimized_intellight.runs/intellight_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intellight_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intellight_blk_mem_gen_0_0.tcl
