...
HD_PWD='F:/Intelligent Traffic Light/optimized_intellight/optimized_intellight.runs/intellight_RAM0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intellight_RAM0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intellight_RAM0_1.tcl
